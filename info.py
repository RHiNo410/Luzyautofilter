...
REQ_CHANNEL =  #Put the channel id without commas or brackets here in which you want to enable join requests feature, and also put the id in above var.
...
DELETE_CHANNELS = [-1001824183542]
MAX_B_TN = environ.get("MAX_B_TN", "5")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
GRP_LNK = environ.get('GRP_LNK')
CHNL_LNK = environ.get('CHNL_LNK')
MSG_ALRT = environ.get('MSG_ALRT', 'How are you?')
LOG_CHANNEL = -1001746556877
